...
public class SujetDto implements Serializable{
	...
	public SujetDto(Integer paramId, String paramTitre, Date paramDate,
			Date paramDateCloture, Boolean paramPublie, TypeSujetDto paramType,
	...
	public SujetDto(Integer paramId, String paramTitre, Date paramDate,
			...
			List<MessageForumDto> paramMessages, TypeSujetDto paramType,
			RubriqueDto paramRubrique) {
		super();
		id = paramId;
		titre = paramTitre;
