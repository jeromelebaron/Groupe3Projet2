...
public class CategorieDto implements Serializable{
	...
	public CategorieDto(Integer paramId, String paramLibelle,
			CategorieDto paramCategorieParent) {
		super();
		id = paramId;
	...
	public CategorieDto(Integer paramId, String paramLibelle,
			List<CategorieDto> paramCategories, CategorieDto paramCategorieParent,
