...
public class ProduitDto implements Serializable{
	...
	public ProduitDto(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, CouleurDto paramCouleur,
			ClientDto paramVendeur, EtatProduitDto paramEtat,
	...
	public ProduitDto(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, CouleurDto paramCouleur,
			ProduitDto paramProduitParent, ClientDto paramVendeur,
	...
	public ProduitDto(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, CouleurDto paramCouleur,
			List<ProduitDto> paramProduitsClients, ProduitDto paramProduitParent,
			ClientDto paramVendeur, EtatProduitDto paramEtat,
			List<NoteProduitDto> paramNotes, CategorieDto paramCategorie,
			List<AlerteProduitDto> paramAlertes,
			/*List<CodeReductionDto> paramCodeReductions, */MarqueDto paramMarque,
			List<ProduitCodeReductionDto> paramProduitsCodesReduction,
			List<ImageDto> paramImages) {
		super();
		id = paramId;
		reference = paramReference;
		libelle = paramLibelle;
	...
	public ProduitDto(String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, CouleurDto paramCouleur,
			ClientDto paramVendeur, EtatProduitDto paramEtat,
			CategorieDto paramCategorie, MarqueDto paramMarque) {
	...
	/*public List<CodeReductionDto> getCodeReductions() {
		return codeReductions;
	}
	public void setCodeReductions(List<CodeReductionDto> paramCodeReductions) {
		codeReductions = paramCodeReductions;
	}*/
	...
	public void setProduitsCodesReduction(
			List<ProduitCodeReductionDto> paramProduitsCodesReduction) {
		produitsCodesReduction = paramProduitsCodesReduction;
	}
