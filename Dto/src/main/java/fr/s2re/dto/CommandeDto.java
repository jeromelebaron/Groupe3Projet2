...
public class CommandeDto implements Serializable{
	...
	public CommandeDto(Integer paramId, String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi, List<LigneDeCommandeDto> paramLignesDeCommande,
			MethodeLivraisonDto paramMethodeLivraison, ClientDto paramClient,
			List<CommandeDto> paramSousCommandes, CommandeDto paramCommandeParente,
			AdresseDto paramAdresseFacturation, AdresseDto paramAdresseLivraison,
			TypeCBDto paramTypeCB, EtatCommandeDto paramEtat, RibDto paramRib) {
		super();
		id = paramId;
		numero = paramNumero;
		total = paramTotal;
	...
	public CommandeDto(Integer paramId, String paramNumero, Double paramTotal,
			...
			MethodeLivraisonDto paramMethodeLivraison, ClientDto paramClient,
			AdresseDto paramAdresseFacturation, AdresseDto paramAdresseLivraison,
			TypeCBDto paramTypeCB, EtatCommandeDto paramEtat,
	...
	public CommandeDto(Integer paramId, String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi, List<LigneDeCommandeDto> paramLignesDeCommande,
			MethodeLivraisonDto paramMethodeLivraison, ClientDto paramClient,
			CommandeDto paramCommandeParente, AdresseDto paramAdresseFacturation,
			AdresseDto paramAdresseLivraison, TypeCBDto paramTypeCB,
			EtatCommandeDto paramEtat, CodeReductionDto paramCodeReduction,
			RibDto paramRib) {
		super();
		id = paramId;
		numero = paramNumero;
