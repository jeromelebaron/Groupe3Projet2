...
public class AlerteCommentaireDto extends AlerteDto implements Serializable{
	...
	public AlerteCommentaireDto(Integer paramId, Date paramDateCreation,
			Date paramDateCloture, UtilisateurDto paramEmeteur,
			ObjetAlerteDto paramObjet, NoteDto paramNote) {
		super(paramId, paramDateCreation, paramDateCloture, paramEmeteur,
				paramObjet);
		note = paramNote;
	}
