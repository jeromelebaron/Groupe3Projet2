...
public class MessageForumDto extends MessageDto implements Serializable{
	...
	public MessageForumDto(Integer paramId, String paramMessage, Date paramDate,
			Date paramDateModif, Boolean paramPublie, List<AlerteMessageDto> paramAlertes) {
		super(paramId, paramMessage, paramDate, paramDateModif, paramPublie, paramAlertes);
	}
	public MessageForumDto(Integer paramId, String paramMessage, Date paramDate, Boolean paramPublie,
			Date paramDateModif) {
