...
public class AssociationDto extends UtilisateurDto implements Serializable{
	...
	public AssociationDto(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			Date paramDateInscription, CiviliteDto paramCivilite, String paramDocument, Boolean paramActif, AdresseDto paramAdresseLivraison) {
	...
	public AssociationDto(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
			String paramTelephone, Date paramDateInscription, CiviliteDto paramCivilite, String paramDocument, Boolean paramActif, AdresseDto paramAdresseLivraison) {
	...
	public AssociationDto(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
			...
			List<AlerteDto> paramAlertes, CiviliteDto paramCivilite, String paramDocument, Boolean paramActif, AdresseDto paramAdresseLivraison, List<DonDto> paramDons) {
	...
	public AssociationDto(String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			Date paramDateInscription, CiviliteDto paramCivilite, String paramDocument, Boolean paramActif, AdresseDto paramAdresseLivraison) {
	...
	public AssociationDto(String paramNom, String paramPrenom, String paramMail, String paramPassword,
			String paramTelephone, Date paramDateInscription, CiviliteDto paramCivilite, String paramDocument, Boolean paramActif, AdresseDto paramAdresseLivraison) {
