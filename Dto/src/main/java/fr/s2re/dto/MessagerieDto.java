...
public class MessagerieDto implements Serializable{
	...
	public MessagerieDto(Integer paramId, ClientDto paramDemandeur,
	...
	public MessagerieDto(Integer paramId, List<MessageInboxDto> paramMessages,
			ClientDto paramDemandeur, ProduitDto paramProduit) {
		super();
		id = paramId;
