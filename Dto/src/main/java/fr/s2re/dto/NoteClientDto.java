...
public class NoteClientDto extends NoteDto implements Serializable{
	...
	public NoteClientDto(Integer paramId, Double paramNote,
			String paramCommentaire, Date paramDate, Boolean paramPublie, ClientDto paramNoteur,
			ClientDto paramVendeur) {
		super(paramId, paramNote, paramCommentaire, paramDate, paramPublie, paramNoteur);
		vendeur = paramVendeur;
	}
	public NoteClientDto(Integer paramId, Double paramNote,
			String paramCommentaire, Date paramDate, Boolean paramPublie, ClientDto paramNoteur,
			List<AlerteCommentaireDto> paramAlertes, ClientDto paramVendeur) {
		super(paramId, paramNote, paramCommentaire, paramDate, paramPublie, paramNoteur,
				paramAlertes);
		vendeur = paramVendeur;
	}
