...
public class Note implements Serializable{
	...
	public Note(Integer paramId, Double paramNote, String paramCommentaire,
			Date paramDate, Boolean paramPublie, Client paramNoteur) {
		super();
		id = paramId;
		note = paramNote;
	...
	public Note(Double paramNote, String paramCommentaire,
			Date paramDate, Boolean paramPublie, Client paramNoteur) {
		super();
		note = paramNote;
		commentaire = paramCommentaire;
