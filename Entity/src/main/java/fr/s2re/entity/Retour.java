...
public class Retour implements Serializable{
	...
	public Retour(Integer paramId, String paramNumero, Date paramDate,
			Integer paramQuantite, LigneDeCommande paramLigneDeCommande,
	...
	public Retour(String paramNumero, Date paramDate,
			Integer paramQuantite, LigneDeCommande paramLigneDeCommande,
			Rib paramRib, TypeRetour paramType) {
		super();
		numero = paramNumero;
