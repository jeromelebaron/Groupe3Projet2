...
public class AlerteCommentaire extends Alerte implements Serializable{
	...
	public AlerteCommentaire(Integer paramId, Date paramDateCreation,
	...
	public AlerteCommentaire(Date paramDateCreation, Date paramDateCloture, Utilisateur paramEmetteur,
			ObjetAlerte paramObjet, Note paramNote) {
