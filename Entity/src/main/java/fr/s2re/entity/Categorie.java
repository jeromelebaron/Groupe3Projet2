...
public class Categorie implements Serializable{
	...
	public Categorie(Integer paramId, String paramLibelle,
			Categorie paramCategorieParent) {
		super();
		id = paramId;
	...
	public Categorie(Integer paramId, String paramLibelle,
			List<Categorie> paramCategories, Categorie paramCategorieParent,
	...
	public Categorie(String paramLibelle, List<Categorie> paramCategories, Categorie paramCategorieParent,
			List<Produit> paramProduits) {
		super();
		libelle = paramLibelle;
		categories = paramCategories;
