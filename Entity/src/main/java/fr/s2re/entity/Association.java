...
public class Association extends Utilisateur implements Serializable{
	...
	public Association(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			Date paramDateInscription, List<MessageForum> paramForumMessages, List<Alerte> paramAlertes,
			Civilite paramCivilite, String paramDocument, Boolean paramActif, Adresse paramAdresseLivraison, List<Don> paramDons) {
	...
	public Association(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
			String paramTelephone, Date paramDateInscription, Civilite paramCivilite, String paramDocument, Boolean paramActif, Adresse paramAdresseLivraison) {
	...
	public Association(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
			String paramTelephone, Date paramDateInscription, List<MessageForum> paramForumMessages,
			List<Alerte> paramAlertes, Civilite paramCivilite, String paramDocument, Boolean paramActif, Adresse paramAdresseLivraison, List<Don> paramDons) {
	...
	public Association(String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			Date paramDateInscription, Civilite paramCivilite, String paramDocument, Boolean paramActif, Adresse paramAdresseLivraison) {
	...
	public Association(String paramNom, String paramPrenom, String paramMail, String paramPassword,
			String paramTelephone, Date paramDateInscription, Civilite paramCivilite, String paramDocument, Boolean paramActif, Adresse paramAdresseLivraison) {
