...
public class Message implements Serializable{
	...
	public Message(Integer paramId, String paramMessage, Date paramDate,
			Date paramDateModif, Boolean paramPublie) {
		super();
		id = paramId;
	...
	public Message(Integer paramId, String paramMessage, Date paramDate,
			Date paramDateModif, Boolean paramPublie, List<AlerteMessage> paramAlertes) {
		super();
		id = paramId;
		message = paramMessage;
		date = paramDate;
	...
	public Message(String paramMessage, Date paramDate,
			Date paramDateModif, Boolean paramPublie) {
		super();
		message = paramMessage;
		date = paramDate;
