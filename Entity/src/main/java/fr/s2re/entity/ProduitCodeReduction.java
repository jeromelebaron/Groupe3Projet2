...
@Entity
@Table(name="produit_code_reduction",
uniqueConstraints=@UniqueConstraint(columnNames={"id_code_reduction","id_produit"}))
public class ProduitCodeReduction implements Serializable{
	...
	public ProduitCodeReduction(Integer paramId,
			CodeReduction paramCodeReduction, Produit paramProduit) {
		super();
		id = paramId;
