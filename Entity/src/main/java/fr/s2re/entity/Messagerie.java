...
public class Messagerie implements Serializable{
	...
	public Messagerie(Integer paramId, Client paramDemandeur,
	...
	public Messagerie(Integer paramId, List<MessageInbox> paramMessages,
			Client paramDemandeur, Produit paramProduit) {
		super();
		id = paramId;
	...
	public Messagerie(Client paramDemandeur,
			Produit paramProduit) {
		super();
		demandeur = paramDemandeur;
		produit = paramProduit;
	}
	public Messagerie(List<MessageInbox> paramMessages,
			Client paramDemandeur, Produit paramProduit) {
		super();
		messages = paramMessages;
		demandeur = paramDemandeur;
