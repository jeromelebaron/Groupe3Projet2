...
public class Rib implements Serializable{
	...
	public Rib(Integer paramId, String paramCodeBanque,
			String paramCodeGuichet, String paramNumeroCompte, String paramCle,
			String paramDomiciliation, String paramIban, String paramBic,
			String paramTitulaire, String paramLibelle, Boolean paramPublie,
			Client paramClient) {
		super();
		id = paramId;
	...
	public Rib(String paramCodeBanque,
			String paramCodeGuichet, String paramNumeroCompte, String paramCle,
			String paramDomiciliation, String paramIban, String paramBic,
			String paramTitulaire, String paramLibelle, Boolean paramPublie,
			Client paramClient) {
