...
public class CartePaiement implements Serializable{
	...
	public CartePaiement(Integer paramId, String paramNumero,
			String paramDetenteur, Date paramDateExpiration,
			Boolean paramPublie, Client paramClient, TypeCB paramType) {
		super();
		id = paramId;
		numero = paramNumero;
	...
	public CartePaiement(String paramNumero, String paramDetenteur, Date paramDateExpiration, Boolean paramPublie,
