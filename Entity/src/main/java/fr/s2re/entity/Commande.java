...
public class Commande implements Serializable{
	...
	public Commande(Integer paramId, String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi, List<LigneDeCommande> paramLignesDeCommande,
			MethodeLivraison paramMethodeLivraison, Client paramClient,
			List<Commande> paramSousCommandes, Commande paramCommandeParente,
			Adresse paramAdresseFacturation, Adresse paramAdresseLivraison,
			TypeCB paramTypeCB, EtatCommande paramEtat, Rib paramRib) {
		super();
		id = paramId;
		numero = paramNumero;
		total = paramTotal;
	...
	public Commande(Integer paramId, String paramNumero, Double paramTotal,
			...
			MethodeLivraison paramMethodeLivraison, Client paramClient,
			Adresse paramAdresseFacturation, Adresse paramAdresseLivraison,
			TypeCB paramTypeCB, EtatCommande paramEtat,
	...
	public Commande(Integer paramId, String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi, List<LigneDeCommande> paramLignesDeCommande,
			MethodeLivraison paramMethodeLivraison, Client paramClient,
			Commande paramCommandeParente, Adresse paramAdresseFacturation,
			Adresse paramAdresseLivraison, TypeCB paramTypeCB,
			EtatCommande paramEtat, CodeReduction paramCodeReduction,
			Rib paramRib) {
		super();
		id = paramId;
		numero = paramNumero;
	...
	public Commande(String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi, List<LigneDeCommande> paramLignesDeCommande,
			MethodeLivraison paramMethodeLivraison, Client paramClient,
			List<Commande> paramSousCommandes, Commande paramCommandeParente,
			Adresse paramAdresseFacturation, Adresse paramAdresseLivraison,
	...
	public Commande(String paramNumero, Double paramTotal,
			Date paramDate, String paramLienSuivi,
			MethodeLivraison paramMethodeLivraison, Client paramClient,
			Adresse paramAdresseFacturation, Adresse paramAdresseLivraison,
			TypeCB paramTypeCB, EtatCommande paramEtat,
			CodeReduction paramCodeReduction, Rib paramRib) {
