...
public class MethodeLivraison implements Serializable{
	...
	public MethodeLivraison(Integer paramId, String paramLibelle,
			Double paramPrix, Boolean paramPublie) {
		super();
		id = paramId;
	...
	public MethodeLivraison(String paramLibelle,
			Double paramPrix, Boolean paramPublie) {
		super();
		libelle = paramLibelle;
		prix = paramPrix;
