...
public class Produit implements Serializable{
	...
	public Produit(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, Couleur paramCouleur,
			Client paramVendeur, EtatProduit paramEtat,
	...
	public Produit(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, Couleur paramCouleur,
			Produit paramProduitParent, Client paramVendeur,
	...
	public Produit(Integer paramId, String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, Couleur paramCouleur,
			List<Produit> paramProduitsClients, Produit paramProduitParent,
			Client paramVendeur, EtatProduit paramEtat,
			List<NoteProduit> paramNotes, Categorie paramCategorie,
			List<AlerteProduit> paramAlertes,
			/*List<CodeReduction> paramCodeReductions, */Marque paramMarque,
	...
	public Produit(String paramReference, String paramLibelle,
			String paramDescription, Integer paramQuantite,
			Double paramPrix, Boolean paramPublie, Couleur paramCouleur,
			Client paramVendeur, EtatProduit paramEtat,
			Categorie paramCategorie, Marque paramMarque) {
	...
	/*public List<CodeReduction> getCodeReductions() {
		return codeReductions;
	}
	public void setCodeReductions(List<CodeReduction> paramCodeReductions) {
		codeReductions = paramCodeReductions;
	}*/
