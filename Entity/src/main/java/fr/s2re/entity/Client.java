...
public class Client extends Utilisateur implements Serializable{
	...
	public Client(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramTelephone,
	...
	public Client(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			...
			Boolean paramActif,
			List<CartePaiement> paramPaiementCartes,
			List<Adresse> paramFacturationAdresses,
			List<Adresse> paramLivraisonAdresses,
			List<NoteClient> paramNotes,
			List<Produit> paramProduits,
			List<Envie> paramEnvies,
			List<Messagerie> paramMessageries,
			List<Commande> paramCommandes,
			List<Rib> paramRibs) {
	...
	public Client(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
	...
	public Client(Integer paramId, String paramNom, String paramPrenom, String paramMail, String paramPassword,
			...
			List<Alerte> paramAlertes, Civilite paramCivilite, 
			Boolean paramActif,
			List<CartePaiement> paramPaiementCartes,
			List<Adresse> paramFacturationAdresses,
			List<Adresse> paramLivraisonAdresses,
	...
	public Client(String paramNom, String paramPrenom, String paramMail, String paramTelephone,
			Date paramDateInscription, Civilite paramCivilite,
			Boolean paramActif) {
