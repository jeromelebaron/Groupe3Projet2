...
public class Adresse implements Serializable{
	...
	public Adresse(Integer paramId, String paramLibelle, String paramNumero,
			String paramRue, Boolean paramPublie, String paramType,
			BigDecimal paramLongitude, BigDecimal paramLatitude,
			Client paramClient, Ville paramVille) {
		super();
		id = paramId;
	...
	public String toString() {
		return "Adresse [libelle=" + libelle + ", numero=" + numero + ", rue="
				+ rue + ", type=" + type + ", ville=" + ville + "]";
	}
}