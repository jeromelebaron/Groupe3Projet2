...
public class Sujet implements Serializable{
	...
	public Sujet(Integer paramId, String paramTitre, Date paramDate,
			Date paramDateCloture, Boolean paramPublie, TypeSujet paramType,
	...
	public Sujet(Integer paramId, String paramTitre, Date paramDate,
			Date paramDateCloture, Boolean paramPublie,
			List<MessageForum> paramMessages, TypeSujet paramType,
			Rubrique paramRubrique) {
		super();
		id = paramId;
		titre = paramTitre;
	...
	public Sujet(String paramTitre, Date paramDate,
			Date paramDateCloture, Boolean paramPublie, TypeSujet paramType,
			Rubrique paramRubrique) {
		super();
		titre = paramTitre;
