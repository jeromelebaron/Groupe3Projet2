...
@Entity
@Table(name="envie",
uniqueConstraints=@UniqueConstraint(columnNames={"id_produit","id_client"}))
public class Envie implements Serializable{
	...
	public Envie(Integer paramId, Integer paramQuantite, Produit paramProduit,
			Client paramClient) {
		super();
		id = paramId;
	...
	public Envie(Integer paramQuantite, Produit paramProduit,
			Client paramClient) {
		super();
		quantite = paramQuantite;
		produit = paramProduit;
