...
public class BusinessCategorie implements IBusinessCategorie{
	...
	public List<CategorieDto> getSousCategorie(CategorieDto paramCategorie) {
		return AssembleurDto.listCategorieDtoFromListCategorie(daoCategorie.getSousCategorie(AssembleurDto.categorieFromCategorieDto(paramCategorie)));
	}
	@Override
	...
	public List<CategorieDto> getCategories(CategorieDto paramCategorie) {
		return AssembleurDto.listCategorieDtoFromListCategorie(daoCategorie.getCategories(AssembleurDto.categorieFromCategorieDto(paramCategorie)));
	}
	@Override
