...
public class UcUtilisateur implements IUcUtilisateur{
	...
	@Override
	public List<CategorieDto> getCatgByCatg(
			CategorieDto paramParaCategorieDto) {
	...
	private void getDansCatEnfants(List<ProduitDto> list,
	...
	@Override
	public List<AlerteCommentaireDto> alerteSurCommentaire(
			NoteProduitDto paramNoteProduitDto) {
		return null;
	}
	@Override
