...
public class ClientMb {
	...
	public String ajouterAdresseL(){
		...
		AdresseDto aDto = new AdresseDto(null, 
				adresseLCusto.getLibelle(), 
				adresseLCusto.getNumero(), 
				adresseLCusto.getRue(), 
				adresseLCusto.getPublie(), 
				adresseLCusto.getType(), 
				null, 
				null, 
				adresseLCusto.getClient(), 
				adresseLCusto.getVille());
	...
	public String ajouterAdresseF(){
		...
		AdresseDto aDto = new AdresseDto(null, 
				adresseFCusto.getLibelle(), 
				adresseFCusto.getNumero(), 
				adresseFCusto.getRue(), 
				adresseFCusto.getPublie(),
				adresseFCusto.getType(), 
				null, 
				null, 
				adresseFCusto.getClient(), 
				adresseFCusto.getVille());
	...
	public String supprimerAdresseL(){
		...
		//on suppr de la liste des adresses dékà récuperé.
